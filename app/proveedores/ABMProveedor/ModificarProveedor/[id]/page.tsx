...
export default function ModificarProveedorPage() {
    ...
    const fetchProveedorData = async () => {
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(`Error ${response.status}: ${errorData.mensaje}`);
        }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(
        `Proveedor "${formData.nombreProveedor.trim()}" modificado exitosamente`
      );
      ...
      <div className="max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("nombreProveedor", e.target.value)
                  }
        ...
        <div className="mt-6 p-4 bg-slate-800 rounded-lg border border-slate-700">
          <h4 className="text-slate-200 font-medium mb-2">
            Información del proveedor original
          </h4>
