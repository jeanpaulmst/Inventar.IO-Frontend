...
import { ArrowLeft, TrendingUp, Plus, List, Users, BarChart3, FileText, DollarSign } from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
          ...
          <SidebarHeader className="border-b border-slate-700 p-4 bg-slate-800">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col gap-0.5 leading-none">
                <span className="font-semibold text-slate-100">Ventas</span>
                <span className="text-xs text-slate-400">Gestión comercial</span>
              </div>
            </div>
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-orange-400 hover:text-orange-300 text-sm mt-3"
            >
